                        ...
                        if (_check_required_fields(formWrap)) {
                            ...
                            if(form_array[0].value == 2){
                                tagIcon = '<div class="'+umPrefix_+'tagdiv" data-tag_id="'+ imageTag.context.currentSrc +'"><div' +
                                    ' class="'+umPrefix_+'circle-ripple"><i class="fa fa-link"></i></div></div>'
                            }else if(form_array[0].value == 3){
                                tagIcon = '<div class="'+umPrefix_+'tagdiv" data-tag_id="'+ imageTag.context.currentSrc +'"><div' +
                                    ' class="'+umPrefix_+'circle-ripple"><i class="fa fa-cart-plus"></i></div></div>'
                            }else{
                                tagIcon = '<div class="'+umPrefix_+'tagdiv" data-tag_id="'+ imageTag.context.currentSrc +'"><div' +
                                    ' class="'+umPrefix_+'circle-ripple"><i class="fa fa-comments"></i></div></div>'
                            }
